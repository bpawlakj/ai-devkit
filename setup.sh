...
check_tool "dotnet"              "install .NET SDK (dotnet.microsoft.com) — for dotnet format"
...
if $DO_CLAUDE; then
    ...
    echo "    Hooks:    8 (ruff, java-format, swiftformat, prettier, goimports, php-cs-fixer, dotnet-format, safety guard)"
